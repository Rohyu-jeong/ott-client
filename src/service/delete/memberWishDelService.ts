  ...
  try {
    const response = await axios
      .delete<MemberWishDelResponseType>(
        `https://ott-roh-frangnc6aaa2dycw.koreacentral-01.azurewebsites.net/wishlist/member/delete?email=${memberWishDelData.email}&movieID=${memberWishDelData.movieID}`,
        {
          headers: {
