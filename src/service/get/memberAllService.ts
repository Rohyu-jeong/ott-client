...
export const fetchMember = async (
  ...
  try {
    const response = await axios.get<MemberResponseType>(
      `https://ott-roh-frangnc6aaa2dycw.koreacentral-01.azurewebsites.net/member/member?email=${email}`,
      {
        headers: {
    ...
    throw error; // 에러를 다시 던져서 호출할 수 있게 합니다.
  }
};
